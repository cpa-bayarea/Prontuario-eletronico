...
@section('titulo', 'Listagem de Drogas')
        ...
        <div class="col s10 offset-s1">
            <div class="card">
                        ...
                        @foreach($dados as $dado)
                            <tr>
                                <td>
                                    ...
                                    <a class="waves-effect waves-light" href="drogas/alterar/{{$dado['id_drogas']}}"><i
                                                class="material-icons left">mode_edit</i></a>
                                    <a href="drogas/deletar/{{$dado['id_drogas']}}"><i
                ...
                <div class="right-align">
                    <a class="btn-floating btn-large waves-effect waves-light" href="{{route('drogas.form')}}"><i

                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" action="{{ route('supervisor.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nome" value="{{ $supervisor->tx_nome }}"
                                           name="tx_nome" required maxlength="100">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="crp" class="col-sm-2 control-label">CRP
                                    <span class="obrigatorio">*</span>
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control inteiro" id="crp"
                                           value="{{ $supervisor->nu_crp }}" name="nu_crp" maxlength="7" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="id_linha" class="form-control" id="linha_teorica" required>
                                        @foreach($linhas as $linha)
                                            ...
                                            @endphp
                                            <option class="form-control" {{ $selected }} value="{{ $linha->id_linha }}">{{ $linha->tx_nome }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control inteiro" id="matricula" name="nu_matricula"
                                           value="{{ $supervisor->nu_matricula }}" maxlength="11" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control inteiro" id="telefone" name="nu_telefone"
                                           value="{{ $supervisor->nu_telefone }}" maxlength="11" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control inteiro" id="celular" name="nu_celular"
                                           value="{{ $supervisor->nu_celular }}" maxlength="11">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" id="email" name="tx_email"
                                           value="{{ $supervisor->tx_email }}" required>
                                </div>
                            </div>
                            <div class="form-group">

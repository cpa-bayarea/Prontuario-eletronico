                ...
                <div class="card-content">
                    ...
                    <!-- TOKEN DO LARAVEL -->
                        <div class="row">
                            ...
                            <div class="input-field col s6 l3">
                                <input name="nu_cep" type="text" id="nu_cep" value="{{$dados['nu_cep'] or null}}"
                                       size="10"
                                       maxlength="9"
                                       class="validate"
                            ...
                            <div class="input-field col s3 l3">
                                <input type="text" id="nu_numero" name="nu_numero"
                                       value="{{$dados['nu_numero'] or null}}"
                                       required class="validate" maxlength="5"/>
                                <!-- maxlength no banco é de 10, foi solicitado alteração-->
                                <label for="numero">Nº</label>
                            </div>
                            <div class="input-field col s6 l3">
                                <input type="text" id="tx_bairro" name="tx_bairro"
                                       value="{{$dados['tx_bairro'] or null}}"
                                       required class="validate"/>
                                <label for="tx_bairro">Bairro</label>
                            </div>
                            <div class="input-field col s6 l3">
                                <input type="text" id="tx_cidade" name="tx_cidade"
                            ...
                            <div class="col s12 l12 right-align">
                                <a href="{{route('paciente.index')}}"> <input type="submit" value="Salvar" id="Salvar"
                                                                              align=""
                                                                              name="salvar" onclick="Novo"

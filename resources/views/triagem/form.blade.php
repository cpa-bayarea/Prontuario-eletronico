...
@section('conteudo')
  ...
  <div class="row">
     ...
     <input type="text" name="tp_grupo" id="tp_grupo" value='{{$paciente->tp_atendimento}}' hidden>
     </div> 
     
     <div class="input-field col s12" align="left"> 
     <label name='queixa' class="active">Queixa principal:</label> 
     <input class="validate" value="{{$paciente['tx_queixa'] or null}}" name="tx_queixa" id="queixa" 
     required 
     ...
     <input class="validate" value="{{$paciente['tx_observacao'] or null}}" name="tx_observacao" id="tx_observacao" 
     required 
     placeholder=""> 
     </div> 
...
<div class="input-field col s6"> 
   <label name="tp_acompanhamento_psic" class="active">Você ou alguem da 
     ...
     família faz acompanhamento psiquiátrico?" >Escolha uma opção</option>
   ...
   <label name="tx_patrimonio" class="active">Você é usuário de drogas?</label> 
     ...
     <input  class="validate"  name="tx_relatorio_acolhimento" id="tx_relatorio_acolhimento" 
     required 
     placeholder=""> 
     </div> 
